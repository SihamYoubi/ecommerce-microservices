package net.siham.billingservice;

import net.siham.billingservice.entities.Bill;
import net.siham.billingservice.entities.ProductItem;
...
/*pour activer open Feign, on utilise cette annotation, ca permet d'interpreter les interfaces qui utilisent
open Feign et les implementer
*/
        ...
        return args -> {
            ...
            customersIds.forEach(clientId -> {
                ...
                productIds.forEach(productId->{
                    ...
                    productItem.setPrice(1000*Math.random()*20);
